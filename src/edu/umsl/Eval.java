...
//    private JRadioButton rb5;
    ...
    private JPanel questionPanel,questionPane2,questionPane3,questionPane4;
...
//            }       
    ...
    private void createUserInterface()
    {
        ...
        questionPanel.setBounds( 40, 100, 320, 75 );
        ...
        questionPanel.add( rb11 );
        questionPanel.add( rb12 );
        questionPanel.add( rb13 );
        questionPanel.add( rb14 );
        questionPanel.add( rb15 );

        

// set up Question Panel and Radio Buttons
        questionPane2 = new JPanel();
        questionPane2.setBounds( 40, 190, 320, 75 );
        questionPane2.setBorder( BorderFactory.createEtchedBorder() );
        questionPane2.setLayout( null );
        contentPane.add( questionPane2 );

        // set up question1 Label
        questionLabel2 = new JLabel();
        questionLabel2.setBounds( 10, 15, 320, 20 );
        questionLabel2.setText( "Q2: Useful?" );
        questionPane2.add( questionLabel2 );
        ...
        // add radio button to the panel
        questionPane2.add( rb21 );
        questionPane2.add( rb22 );
        questionPane2.add( rb23 );
        questionPane2.add( rb24 );
        questionPane2.add( rb25 );

// set up Question Panel and Radio Buttons
        questionPane3 = new JPanel();
        questionPane3.setBounds( 40, 280, 320, 75 );
        questionPane3.setBorder( BorderFactory.createEtchedBorder() );
        questionPane3.setLayout( null );
        contentPane.add( questionPane3 );

        // set up question1 Label
        questionLabel3 = new JLabel();
        questionLabel3.setBounds( 10, 15, 320, 20 );
        questionLabel3.setText( "Q3: Clarity?" );
        questionPane3.add( questionLabel3 );
        ...
        // add radio button to the panel
        questionPane3.add( rb31 );
        questionPane3.add( rb32 );
        questionPane3.add( rb33 );
        questionPane3.add( rb34 );
        questionPane3.add( rb35 );

        

// set up Question Panel and Radio Buttons
        questionPane4 = new JPanel();
        questionPane4.setBounds( 40, 370, 320, 75 );
        questionPane4.setBorder( BorderFactory.createEtchedBorder() );
        questionPane4.setLayout( null );
        contentPane.add( questionPane4 );

        // set up question1 Label
        questionLabel4 = new JLabel();
        questionLabel4.setBounds( 10, 15, 320, 20 );
        questionLabel4.setText( "Q4: Overall?" );
        questionPane4.add( questionLabel4 );
        ...
        // add radio button to the panel
        questionPane4.add( rb41 );
        questionPane4.add( rb42 );
        questionPane4.add( rb43 );
        questionPane4.add( rb44 );
        questionPane4.add( rb45 );
...
// SUBMIT BUTTON SET UP!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        buttonPanel.setBounds( 40, 600, 320, 80 );
        buttonPanel.setBorder( BorderFactory.createEtchedBorder() );
        buttonPanel.setLayout( null );
        contentPane.add( buttonPanel );

        submitButton = new JButton( "SUBMIT" );
        submitButton.setBounds(20, 15, 100, 50);
        submitButton.setVisible(true);
        buttonPanel.add(submitButton);
        submitButton.addActionListener(this);
        
        clearButton = new JButton( "CLEAR" );
        clearButton.setBounds(200, 15, 100, 50);
